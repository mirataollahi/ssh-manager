...
')
     ...
     *
     */ 
        class LocalCacheFacade {
                    /**
         * 
         *
         * @return \App\Services\Cache\LocalCacheService 
         * @static 
         */ 
        public static function getInstance()
        {
                        return \App\Services\Cache\LocalCacheService::getInstance();
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Cache\LocalCacheService $instance */
                        return $instance->get($key, $callback);
        }
...
namespace  { 
            ...
            class LocalCache extends \App\Facades\LocalCacheFacade {}
